...
namespace DrentL1.Auth
{
    ...
    {
        Task<AuthResponse> CreateAccessTokenAsyc(SystemUser user);
    ...
    public class TokenManager : ITokenManager
    {
        ...
        public TokenManager(IConfiguration configuration, UserManager<SystemUser> manager, IRefreshTokenGenerator refreshTokenGenerator, IRefreshTokenRepository refreshToken)
        {
        ...
        public async Task<AuthResponse> CreateAccessTokenAsyc(SystemUser user)
        {
